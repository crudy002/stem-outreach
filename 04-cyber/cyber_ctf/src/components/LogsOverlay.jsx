...
const buildLogPool = (flagPath) => [
  ...
  { text: `nginx: 10.0.4.17 - - "GET /${flagPath} HTTP/1.1" 200 214`, flag: true },
...
export function LogsOverlay({ onClose, flagPath = 'config/credentials.txt' }) {
  const LOG_POOL = buildLogPool(flagPath);
